...
MODULE Chemistry_Mod  ! chemistry_mod is the name of the chemistry module in SOSA. In MALTE-BOX the chemistry module is called CHEMISTRY.
  ...
  PUBLIC :: set_emissions_for_chemistry, set_soil_emissions_for_chemistry_1, set_soil_emissions_for_chemistry_2, set_clearcut_emissions_for_chemistry
  public :: set_emissions
...
!----------------------------------------------------------------------------------------------------------------------
    ...
    I_ACF(1:NWL) = radiation_in * swr_distribution(1:NWL) * (1 + 2 * albedo_in * COS(zenith_deg*3.14/180) + albedo_in)
