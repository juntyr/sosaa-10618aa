...
subroutine acdc_plugin(names_vapor,c_vapor,cs_ref,temp,ipr,t_sim,t_tot,j_acdc,diameter_acdc,ss_handle,stepback,printnow,c_out,c_bins,n_clusters)
...
use driver_acdc_J_0x1, only : acdc_driver_0x1
    ...
    ! Optional output
    real(kind(1.d0)), intent(inout), optional :: n_clusters(:)   ! concentration of clusters. If sent in, will replace the internal c-vector
